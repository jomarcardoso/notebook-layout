...
export const Avatar: FC<AvatarProps> = ({
  ...
  return (
    <div className={classes}>
      {src ? (
        <img alt={alt} className="avatar__img" src={src} {...props} />
      ) : (
        <img
          alt=""
          aria-hidden="true"
